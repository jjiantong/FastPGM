...
pair<double, set<Node*>> Network::F(Node *node,
        ...
        Dataset *dts,
        map<Node*, map<set<Node*>, double>> &dynamic_program_for_F) { //checked
...
pair<double, vector<pair<Node*, set<Node*>>>>
 Network::Q(set<Node*> &set_nodes,
         ...
         map<pair<set<Node*>, vector<int>>,   pair<double, vector<pair<Node*, set<Node*>>>>> dynamic_program_for_Q) { //checked
...
vector<int> Network::M(set<Node*> &set_nodes,
        ...
        map<set<Node*>, vector<int>> dynamic_program_for_M) { //checked
